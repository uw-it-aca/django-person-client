    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qtr_grade_points', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('qtr_graded_attmp', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ('qtr_nongrd_attmp', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ('class_code', models.SmallIntegerField(blank=True, null=True)),
                ...
                ('tenth_day_credits', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ('tr_en_stat_dt', models.DateTimeField(blank=True, null=True)),
                ('last_changed', models.DateTimeField(blank=True, db_column='_last_changed', null=True)),
                ('over_qtr_deduct', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ('over_qtr_grade_at', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ('over_qtr_grade_pt', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('over_qtr_nongrd', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ('qtr_comment', models.TextField(blank=True, null=True)),
                ('qtr_deductible', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ('qtr_nongrd_earned', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ...
                ('enroll_status_desc', models.TextField(blank=True, null=True)),
                ('special_program_desc', models.TextField(blank=True, null=True)),
                ('cmp_qtr_deductible_credits', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
                ('cmp_qtr_grade_points', models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)),
                ('cmp_qtr_graded_attempted', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
                ('cmp_qtr_nongraded_earned', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
                ('cmp_qtr_total_attempted', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
                ('cmp_qtr_graded_earned', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
                ('cmp_qtr_total_earned', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
                ('cmp_qtr_gpa', models.TextField(blank=True, null=True)),
                ('cmp_cum_total_attempted', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
                ('cmp_cum_graded_attempted', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
                ('cmp_cum_grade_points', models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)),
                ('cmp_cum_gpa', models.TextField(blank=True, null=True)),
                ('cmp_cum_graded_earned', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
                ('cmp_cum_uw_earned', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
                ('cmp_cum_total_earned', models.DecimalField(max_digits=5, decimal_places=1, blank=True, null=True)),
