    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree_uw_credits', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
                ('degree_transfer_credits', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
                ('degree_extension_credits', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qtr_grade_points', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
                ('qtr_graded_attmp', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
                ('class_code', models.SmallIntegerField(blank=True, null=True)),
                ...
                ('tenth_day_credits', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
                ('tr_en_stat_dt', models.DateTimeField(blank=True, null=True)),
                ('last_changed', models.DateTimeField(blank=True, db_column='_last_changed', null=True)),
                ('over_qtr_deduct', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
                ('over_qtr_grade_at', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
                ('over_qtr_grade_pt', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
                ('over_qtr_nongrd', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
                ('qtr_comment', models.TextField(blank=True, null=True)),
                ('qtr_deductible', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
                ('qtr_nongrd_earned', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transfer_gpa', models.DecimalField(blank=True, decimal_places=5, max_digits=5, null=True)),
