...
class TranscriptTest(ModelTest):
    def test_get_transcripts(self):
        ...
        self.assertEqual(t3.deductible_credits, 0.0)
        self.assertEqual(t3.grade_points, 19.5)
        self.assertEqual(t3.graded_attempted, 5.0)
        self.assertEqual(t3.nongraded_earned, 0.0)
        self.assertEqual(t3.total_attempted, 5.0)
        self.assertEqual(t3.total_earned, 5.0)

        data = t3.to_dict()
        self.assertEqual(data['deductible_credits'], 0.0)
        self.assertEqual(data['grade_points'], 19.5)
        self.assertEqual(data['graded_attempted'], 5.0)
        self.assertEqual(data['nongraded_earned'], 0.0)
        self.assertEqual(data['total_attempted'], 5.0)
        self.assertEqual(data['total_earned'], 5.0)
        ...
        self.assertEqual(t2.total_earned, 5.0)
